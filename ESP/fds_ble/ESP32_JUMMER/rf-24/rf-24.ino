...
//RF24 radio(22, 21, 4000000);  /// CAN SET SPI SPEED TO 16000000 BY DEFAULT ITS 10000000
RF24 radio(16, 15, 4000000);  /// CAN SET SPI SPEED TO 16000000 BY DEFAULT ITS 10000000
